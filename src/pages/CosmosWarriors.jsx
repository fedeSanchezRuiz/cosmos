...
import MainScreen from '../components/gameComponents/screens/MainScreen';
  ...
  return (
    <>
      {(gameSteps === 'main-screen' && (
        <MainScreen
          onStepChange={() => setGameSteps('introduction')}
        />
      )) ||
        (gameSteps === 'introduction' && (
          <Introduction
            onStepChange={() => setGameSteps('fight')}
          />
        )) ||
        (gameSteps === 'fight' && (
          <FightStage
            onStepChange={(outcome) =>
              setGameSteps(`conclusion-${outcome}`)
            }
          />
        )) ||
